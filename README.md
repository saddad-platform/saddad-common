...
whether it is a patch, a minor or a major, sets it in the POM, tags it, creates the release and
waits for JitPack to build it. Say `feat:` when you add something and `feat!:` when you break
something; anything else is a patch. [RELEASING.md](RELEASING.md) has the detail.
